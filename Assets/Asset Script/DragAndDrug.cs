...
public class DragAndDrug : MonoBehaviour, IPointerDownHandler , IBeginDragHandler, IEndDragHandler, IDragHandler, IDropHandler
{
    [SerializeField] private Canvas canvas;
    private RectTransform rectTransform;
    public int can;
    private CanvasGroup canvasGroup;
    public GameObject Hilang1, Hilang2, Hilang3, Hilang4, Hilang5;
    private void Awake()
    {
